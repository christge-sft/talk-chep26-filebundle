...
bundle records these dependencies allowing the client to fetch them eagerly in parallel in advance.
...
The feature is disabled by default and can be enabled per mount with the configuration parameter
